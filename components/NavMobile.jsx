...
import { RiHome2Fill, RiMenu2Line, RiMenuFill } from "react-icons/ri";
import { IoCloseOutline, IoCloudOutline } from "react-icons/io5";
...
const links = [
  { icon: <RiMenu2Line />, path: "home", name: "home", offset: 0 },
  { icon: <BiSolidFoodMenu />, path: "menu", name: "menu", offset: 0 },
  { icon: <FaUsers />, path: "about", name: "about", offset: -50 },
  { icon: <RiHome2Fill />, path: "contact", name: "contact", offset: 0 },
];
  ...
  return (
    <div className={`${containerStyles}`}>
      ...
      <aside
        ...
        bg-black/95 fixed z-20 w-[80%] p-10 top-0 bottom-0 transition-all duration-500`}
      >
